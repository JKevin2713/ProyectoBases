    ...
    public partial class PantallaTabla : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                insertarTabla.setConexionActiva(conexionActiva);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                editarTabla.setConexionActiva(conexionActiva);
        ...
        private void eliminar_Empleados()
        {
            ...
            if (conexionActiva)
            {
                DB.CorporacionDB corporacionDB = new DB.CorporacionDB();
                corporacionDB.eliminarEmpleado(idE, Connection);
            }
            else
            {
                int codigoPlanta = 0;
                ...
                {
                    case "Guayabo":
                        codigoPlanta = 1; break;
                    case "Central":
                        codigoPlanta = 2; break;
                    case "La Romana":
                        codigoPlanta = 3; break;
                }

                sinCone.exportarEmpleadoEliminado(idE, codigoPlanta);
            }
        }
        ...
        private void eliminar_Planilla()
        {
            ...
            {
                DB.CorporacionDB corporacionDB = new DB.CorporacionDB();
                corporacionDB.eliminarPlanilla(idE);
            }
            else
            {
                int codigoPlanta = 0;
                ...
                sinCone.exportarPlanillaEliminada(idE, codigoPlanta);
            }
