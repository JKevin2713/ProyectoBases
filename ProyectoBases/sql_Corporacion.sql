...
WHERE
    idEmpleado = 3;  -- Ajusta el valor según el ID del empleado que deseas actualizar
...
VALUES ('María López', '2023-02-15', 9, 18, 2, 2, 'Contabilidad', 0, 1);
UPDATE Empleado
SET
...
BEGIN
    BEGIN TRY
        ...
        BEGIN
            -- Si el idpago no existe, lanzar una excepción
